...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //    (paciente cero), tal como se pide.
        // ------------------------------------------------------------
        ...
        // 6. La persona 2 (manos contaminadas) tiene contacto con la persona 3
        //    -> Transmite el virus a las manos de la persona 3
        
        persona2.tenerContacto(persona3);

        // 7. La persona 2 todavia no esta infectada, solo tiene las manos
        //    contaminadas -> Invariante 3

        System.out.println("\n¿La persona 2 esta infectada antes de tocarse el rostro? "
                + (persona2.estaInfectada() ? "SI" : "NO"));

        // 8. La persona 2 se toca el rostro con las manos contaminadas
        //    -> Invariante 4: ahora si se infecta
  
        persona2.tocarRostro();

        // 9. La persona 3 decide lavarse las manos ANTES de tocarse el rostro

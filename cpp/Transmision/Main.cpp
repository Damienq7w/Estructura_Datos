 ...
 *  Version: C++
 *  Integrante 6: Programador C++ y Analisis de Memoria
 * ================================================================
 * Problema:
...
int main() {
    ...
    // Pausa para que la consola de Dev-C++ no se cierre automaticamente
    // al terminar el programa y se pueda leer el resultado.
    system("pause");
